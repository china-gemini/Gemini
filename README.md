...
全面体验 [**Gemini 中文版**](https://chat.lanjingai.org)，**国内直连，无需翻墙**，**支持 Gemini 2.5 Pro、Gemini 2.5 flash、Nano Banana 及中文版功能**   
...
2. [国内可用的 Gemini 中文网站](#国内可用的-gemini-中文网站)
...
- [chat.lanjingai.org](https://chat.lanjingai.org/) - **Gemini 中文站**，支持 gemini-2.5-pro、gemini-2.5-flash、nano banana、claude 4 sonnet、Grok 4、GPT-5、4o、o1、o3 及 DeepSeek R1 最先进的模型，无限使用~
- [chat.yixiaai.com](https://xsimplechat.com/) - **Gemini 中文版**，支持 gemini-2.5-pro、gemini-2.5-flash、nano banana、claude-4-sonnet、GPT-5、o1、o3 及 Grok-4，支持 AI 绘画，扫码即可使用。
